...
public class PreferenceUtil {
	...
	private static final String SHARED_FILE_TITLE = "pref_themevs";
	public final static String PREF_SOUND_EFFECT = "pref_sound_effect";
	public final static String PREF_SOUND_EFFECT_SET = "pref_sound_effect_set";
	public final static String PREF_TAB_SELECTED = "pref_tab_selected";
	public final static String PREF_CONTENT_STATUS = "pref_content_status";
